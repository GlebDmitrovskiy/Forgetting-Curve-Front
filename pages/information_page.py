...
class InformationPage:
    ...
    def input_id_for_delete(self, id):
        self.find(self.locators.delete_id_user_locator).send_keys(id)
    ...
    def get_information(self):
        self.find(self.locators.get_user_information_button_locator).click()

    def delete_user_information(self):
        self.find(self.locators.delete_id_user_locator).click()
